...
enum BuilderStatus { IMU_INIT, MAP_INIT, MAPPING };
...
class MapBuilder {
 public:
  ...
  void setLocalizationGlobalMap(CloudType::Ptr cloud) { m_localization_global_map = cloud; }
 ...
 private:
  ...
  CloudType::Ptr m_localization_global_map;
};
